...
DATA_INICIO = "202005"                 #YYYYMM
DATA_FIM    = "202012"                 #YYYYMM
MINIO_ENDPOINT = "http://localhost:9002"
MINIO_USER = "minioadmin"
MINIO_PASS = "minioadmin"
BRONZE_BUCKET = "bronze-bolsa-familia-json"
URL_API_IBGE = "https://servicodados.ibge.gov.br/api/v1/localidades/municipios"
URL_API_PORTAL_DA_TRANSPARENCIA = "https://api.portaldatransparencia.gov.br/api-de-dados/bolsa-familia-por-municipio"
HEADERS_API_PORTAL_DA_TRANSPARENCIA = {"chave-api-dados": "4e8b88ff1d759d645f3afe654aa6e174"}
REQUEST_COUNT = 0
REQUEST_LIMIT = 150 #limite permitido pela API
PAUSE_SECONDS = 60
...
for yyyymm in datas(DATA_INICIO, DATA_FIM) :
    for codigo in codigos_ibge(URL_API_IBGE):
        ...
        for rec in registros:
            ...
            put_json_minio(s3_client, BRONZE_BUCKET, name_file_output_json, rec)
            total_enviados += 1
